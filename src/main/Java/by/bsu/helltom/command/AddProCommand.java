...
public class AddProCommand implements Command{
    ...
    public String execute(HttpServletRequest req, HttpServletResponse res) throws SQLException, ClassNotFoundException, UnsupportedEncodingException {
        ...
        System.out.println(cate_proid_new + name + null + introduce + price + stock_new + status + createtime + updatetime);

        Product product1 = new Product(0, cate_proid_new, name, null, introduce, price, stock_new, status, createtime, updatetime);
